...
class RendererTest(unittest.TestCase):
    def test_original_codes_preserved_after_rotation(self):
        ...
        self.assertEqual((page['widthMm'],page['heightMm']),(72,96))
        raster_bytes=base64.b64decode(page['rasterBase64'])
        self.assertEqual(len(raster_bytes),55296)
        self.assertEqual((page['rasterWidth'],page['rasterHeight']),(576,768))
        raster=Image.frombytes('1',(576,768),raster_bytes)
