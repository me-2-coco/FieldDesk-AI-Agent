...
function RepairProcess({ setPage }) {
  ...
  const [faultKeyword, setFaultKeyword] = useState(
    repairOrder.faultCategory || ""
  )


  const [selectedFault, setSelectedFault] = useState(
    repairOrder.selectedFault || null
  )
...
setFaultKeyword(e.target.value)
