...
function MachineTracking({ setPage }) {
  ...
  return <div className="page machine-tracking-page">
    <div className="top-bar backoffice-page-header"><button className="arrow-back" aria-label="退出应用" onClick={() => setPage("appBack")}>←</button><div><small>查询与档案</small><h1>机器去向</h1></div></div>
