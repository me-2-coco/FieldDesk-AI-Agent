...
function InformationRepairReports({ setPage, initialRmaNo = "" }) {
  ...
  return <div className="page information-report-page">
    <div className="top-bar backoffice-page-header"><button className="arrow-back" aria-label={report ? "返回档案列表" : "退出应用"} onClick={() => preview ? closePreview() : report ? setReport(null) : setPage("appBack")}>←</button><div><small>查询与档案</small><h1>维修档案</h1></div></div>
    {!report && <>
